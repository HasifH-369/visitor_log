              ...
              child: OutlinedButton(
                onPressed: () async {
                  ...
                  if (fname.isEmpty) {
                    valid = false;
                    showMessage(
                        context, "Please enter first name!", Colors.orange);
                  }
                  if (lname.isEmpty) {
                    valid = false;
                    showMessage(context, "Please enter last name!", Colors.orange);
                  }
                  if (purpose.isEmpty) {
                    valid = false;
                  ...
                  if (whomToMeet.isEmpty) {
                    valid = false;
                    showMessage(context,
                        "Please enter whom do you intent to meet!", Colors.orange);
                  }
                  ...
                  if (valid) {
                    if (await sendVisitorData(
                      ...
                      showMessage(
                          context, "Failed to add visitor!", Colors.orange);
                    }
                  }
                },
                child: Text(
